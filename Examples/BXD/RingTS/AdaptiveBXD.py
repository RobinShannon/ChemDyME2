...
narupa_mol.set_calculator(XTB(method="GFN1xTB", electronic_temperature=1000))
...
path = Path.Path(narupa_path, collective_var,  stride=2, max_distance_from_path=1.0)
progress = PM.Curve(collective_var, path,  max_nodes_skiped=3)
#progress = PM.Line(narupa_mol, collective_var, narupa_end)
md = MD.Langevin(narupa_mol, temperature=800, friction=0.00001, timestep=0.5)
