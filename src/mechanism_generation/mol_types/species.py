        ...
        for i in range(0,int(steps)):
            ...
            for j in range(0,int(steps)):
                ...
                for k in range(0,int(steps)):
                    ...
                    angle_arr_1D.append(a)
                    if k == (int(steps) -1):
                        ene_arr_1D_temp.append(ene_arr_1D_temp[-int(steps)])
                        angle_arr_1D.append(angle_arr_1D[-int(steps)])
                        arr.append(arr[-int(steps)])
                ene_arr_2D.append(arr)
                if j == (int(steps) -1):
                    ene_arr_2D.append(ene_arr_2D[-int(steps)])
            ene_arr_2Ds.append(ene_arr_2D)
            if i == int(steps) -1:
                ene_arr_2Ds.append(ene_arr_2Ds[-int(steps)])
