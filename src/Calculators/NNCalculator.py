...
from src.neural_network.NeuralNetwork import *
from src.neural_network.activation_fn import *
...
class NNCalculator(Calculator):
    ...
    def __init__(self,
                 ...
                 s6=0.5,                        #s6 coefficient for d3 dispersion, by default is learned
                 s8=0.213,                        #s8 coefficient for d3 dispersion, by default is learned
                 a1=0.0,                        #a1 coefficient for d3 dispersion, by default is learned
                 a2=6.0519,                        #a2 coefficient for d3 dispersion, by default is learned
    ...
    def calculate(self, atoms: Optional[Atoms] = None, properties=('energy', 'forces'),system_changes=all_changes):
        ...
        self.results['energy'] = self._last_energy[0]
        self.results['forces'] = self._last_forces
        #store copy of atoms
